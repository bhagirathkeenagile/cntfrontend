...
const nav = [
  { name: 'Maps', href: '/map', icon: Lot, current: false },
  { name: 'Contacts', href: '/contacts', icon: UsersIcon, current: false },
  { name: 'Accounts', href: '/accounts', icon: BanknotesIcon, current: false },
]


const ar = [
  { name: 'Roles', href: '/role', icon: Role, current: false },
  { name: 'Permissions', href: '/permission', icon: Permission, current: false },
  { name: 'Internal Brand', href: '/internalBrands', icon: BookmarkSquareIcon, current: false },
