        ...
        Add More                                              
                        ...
                        <div className='p-4'>
                            ...
                            <div className='flex justify-between items-center mt-3'>
                                <a href='#'>
                                    <CheckCircleIcon className='h-5 inline-block text-blue-500' />
                                    <span className='text-sm font-normal ml-4'>New Area</span>
                                </a>
                                <div>
                                  <button> <PencilSquareIcon className='h-5 inline-block text-blue-300 mr-3'/></button> 
                                  <button> <TrashIcon className='h-5 inline-block text-red-400'/></button> 
                                </div>
                            </div>
                            <div className='flex justify-between items-center mt-3'>
